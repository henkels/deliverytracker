...
//        FirebaseAuth.getInstance().signOut();
    ...
    private void checkGoolePlayServicesApi() {
        ...
        if (isGooglePlayServicesAvailable != ConnectionResult.SUCCESS) {
            gApiAvailability.showErrorNotification(this, isGooglePlayServicesAvailable);
        }
        isGooglePlayServicesAvailable = gApiAvailability.isGooglePlayServicesAvailable(this);
        if (isGooglePlayServicesAvailable != ConnectionResult.SUCCESS) {
            System.exit(0);
        }
    }
