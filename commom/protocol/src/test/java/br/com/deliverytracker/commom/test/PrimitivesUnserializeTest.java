...
public class PrimitivesUnserializeTest {
    ...
    private void doTest(String tested) {
    ...
    public void sanityTest() {
        Object object = ToMapSerializer.fromJson(EMPTY_OBJECT);
    ...
    @Test
    public void test004() {
        doTest(TWO_DOUBLE_QUOTE_STRING);
    }
